...
const string strMessageMagic = "tcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 14401)
    {
      nSubsidy = 60 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "tcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "tcoin FTW 1234567890";
        CTransaction txNew;
        txNew.nTime = 1428675389;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1428675389;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3601014;
		if(fTestNet)
        {
            block.nNonce   = 3601014;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x200966ceda207cfa91cb4da7098d2492ab13223482af70b62de3f4153ceb9873"));
        block.print();
